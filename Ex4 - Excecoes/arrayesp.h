...
class posi_ocupada: public exception{
    public:
        virtual const char* what(){
            return "Posicao ja esta ocupada";
        }
};
class posi_invalida: public exception{
    public:
        virtual const char* what(){
            return "Posicao desejada eh invalida";
        }
};
class posi_liberada: public exception{
    public:
        virtual const char* what(){
            return "Posicao ja esta liberada";
        }
